                  ...
                  <ul className="nav nav-tabs nav-tabs-line">
                     ...
                     <li className="nav-item">
                        <button
                           className="nav-link"
                           data-bs-toggle="tab"
                           data-bs-target="#chat-media-videos"
                           type="button"
                        >
                           Videos{" "}
                        </button>
                     ...
                     <li className="nav-item">
                        <button
                           className="nav-link"
                           data-bs-toggle="tab"
                           data-bs-target="#chat-media-files"
                           type="button"
                        >
                           Files{" "}
                        </button>
                     ...
                     <li className="nav-item">
                        <button
                           className="nav-link"
                           data-bs-toggle="tab"
                           data-bs-target="#chat-media-links"
                           type="button"
                        >
                           Links{" "}
                        </button>
                        ...
                        <ul className="tyn-media-list gap gap-3">
                              ...
                              <a href="#" className="tyn-links">
                                 <div className="tyn-media-group">
                                    <div className="tyn-media tyn-size-xl">
                                       <img src="../../../src/assets/images/gallery/chat/thumb-7.jpg" alt="" />
                                    </div>
                                    <div className="tyn-media-col">
                           ...
                           <li>
                              <a href="#" className="tyn-links">
                                 <div className="tyn-media-group">
                                    <div className="tyn-media tyn-size-xl">
                                       <img src="../../../src/assets/images/gallery/chat/thumb-8.jpg" alt="" />
                                    </div>
                                    <div className="tyn-media-col">
